...
export class PlayState extends AbstractState {
    ...
    create() {
        ...
        this.game.graphics = this.game.add.graphics();
        this.base.add(this.game.graphics);
        ...
        this.uiPanel.add(this.sitesText = new SlickUI.Element.Text(20, 5, "Sites", 16, 'minecraftia', 90, 20));
        this.uiPanel.add(this.delaunayCheck = new SlickUI.Element.Checkbox(0, 20));
        this.uiPanel.add(this.delaunayText = new SlickUI.Element.Text(20, 25, "Delaunay", 16, 'minecraftia', 90, 20));
        this.uiPanel.add(this.voronoiCheck = new SlickUI.Element.Checkbox(0, 40));
        this.uiPanel.add(this.voronoiText = new SlickUI.Element.Text(20, 45, "Voronoi", 16, 'minecraftia', 90, 20));
        this.uiPanel.add(this.terrainCheck = new SlickUI.Element.Checkbox(0, 60));
        this.uiPanel.add(this.terrainText = new SlickUI.Element.Text(20, 65, "Terrain", 16, 'minecraftia', 90, 20));
    ...
    resize(width, height) {
        this.terrain.debugGroup.centerX = this.game.world.centerX;
        this.terrain.debugGroup.centerY = this.game.world.centerY;
        this.terrain.baseLayer.centerX = this.game.world.centerX;
        this.terrain.baseLayer.centerY = this.game.world.centerY;
    }
